...
<section class="bg-white dark:bg-gray-900 ">
    <div class="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
        <div class="wf-ull lg:w-1/2">
            ...
            <p class="mt-4 text-gray-500 dark:text-gray-400">Yikes, can't find that page. Try something else</p>

            <div class="flex items-center mt-6 gap-x-3">
                <button onclick="javascript:history.go(-1)" title="Return to previous page" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700">
